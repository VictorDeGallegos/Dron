...
public class Sensores : MonoBehaviour
{
  ...
  public Radar radar; // Componente auxiliar (script) para utilizar radar esférico
  public Rayo rayo; // Componente auxiliar (script) para utilizar rayo lineal
  public Bateria bateria; // Componente adicional (script) que representa la batería
  public Actuadores actuador; // Componente adicional (script) para obtener información de los ac
  ...
  // Asignaciones de los componentes
  //   void Start()
  //   {
